...
Бекенд переписан на nest
На фронте начата миграция на mui, а также же нахожу порядок в коде 
...
Принято решение пересмотреть(проект больше как хобби и не хватает времени все самостоятельно делать).
